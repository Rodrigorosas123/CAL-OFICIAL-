...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      div(class = "loading", id = "loading", "Cargando... Espere por favor.")
    )
  )
)
...
server <- function(input, output, session) {
  ...
  data <- reactive({
    ...
    showModal(modalDialog(
      ...
      "Por favor, espere mientras procesamos el archivo...",
      easyClose = FALSE
    ))
    ...
    # Ocultar el indicador de carga una vez cargado el archivo
    removeModal()
